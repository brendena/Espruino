...
__attribute__((weak)) void jswrap_banglejs_pwrBacklight(bool on) {
  jshPinOutput(LCD_BL, on);
}


__attribute__((weak)) void backlight_init(){}
__attribute__((weak)) void backlight_kill(){}
__attribute__((weak)) void backlight_idle(){}
